#macro __SCRIBBLE_VBUFF_FAST_READ_GLYPH  var _quad_l = _vbuff_pos_grid[# _i, __SCRIBBLE_GEN_VBUFF_POS.__QUAD_L];\
...
#macro __SCRIBBLE_VBUFF_FAST_WRITE_GLYPH  if (_glyph_texture != _last_glyph_texture)\
                                          {\
                                          ...
                                          ;\
                                          vertex_position_3d(_vbuff, _quad_l, _quad_t, _glyph_sprite_data); vertex_argb(_vbuff, _write_colour); vertex_texcoord(_vbuff, _quad_u0, _quad_v0); vertex_float1(_vbuff, _glyph_scale);\
                                          vertex_position_3d(_vbuff, _quad_r, _quad_b, _glyph_sprite_data); vertex_argb(_vbuff, _write_colour); vertex_texcoord(_vbuff, _quad_u1, _quad_v1); vertex_float1(_vbuff, _glyph_scale);\
                                          vertex_position_3d(_vbuff, _quad_l, _quad_b, _glyph_sprite_data); vertex_argb(_vbuff, _write_colour); vertex_texcoord(_vbuff, _quad_u0, _quad_v1); vertex_float1(_vbuff, _glyph_scale);\
                                          vertex_position_3d(_vbuff, _quad_r, _quad_b, _glyph_sprite_data); vertex_argb(_vbuff, _write_colour); vertex_texcoord(_vbuff, _quad_u1, _quad_v1); vertex_float1(_vbuff, _glyph_scale);\
                                          vertex_position_3d(_vbuff, _quad_l, _quad_t, _glyph_sprite_data); vertex_argb(_vbuff, _write_colour); vertex_texcoord(_vbuff, _quad_u0, _quad_v0); vertex_float1(_vbuff, _glyph_scale);\
                                          vertex_position_3d(_vbuff, _quad_r, _quad_t, _glyph_sprite_data); vertex_argb(_vbuff, _write_colour); vertex_texcoord(_vbuff, _quad_u1, _quad_v0); vertex_float1(_vbuff, _glyph_scale);



function __scribble_gen_9_write_vbuffs_fast()
{
    ...
    repeat(__pages)
    {
        ...
        repeat(_page_data.__glyph_count)
        {
            ...
            {
                if (_control_grid[# _control_index, __SCRIBBLE_GEN_CONTROL.__TYPE] == __SCRIBBLE_GEN_CONTROL_TYPE.__COLOUR)
                {
            ...
            if (_glyph_ord == __SCRIBBLE_GLYPH_SPRITE)
            {
                ...
                repeat((_image_speed > 0)? _sprite_number : 1) //Only draw one image if we have an image speed of 0 since we're not animating
                {
                    ...
                    __SCRIBBLE_VBUFF_FAST_WRITE_GLYPH;
            ...
            else if (_glyph_ord == __SCRIBBLE_GLYPH_SURFACE)
            {
                ...
                __SCRIBBLE_VBUFF_FAST_READ_GLYPH;
            ...
            else //Writing a standard glyph
            {
                ...
                if ((_glyph_ord > 0x20) && (_glyph_ord != 0xA0) && (_glyph_ord != 0x200B))
                {
                    ...
                    vertex_position_3d(_vbuff, _quad_l, _quad_t, _glyph_sprite_data);
                    vertex_argb(_vbuff, _write_colour);
                    vertex_texcoord(_vbuff, _quad_u0, _quad_v0);
                    vertex_float1(_vbuff, _glyph_scale);
